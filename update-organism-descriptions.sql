...
UPDATE organism SET description=
'Arachis ipaensis, native to Bolivia, is thought to be one of the diploid ancestors of cultivated peanut. The genome of A. ipaensis has been sequenced as part of the Peanut Genomics Initiative, to help in the accurate assembly of the tetraploid domestic peanut, A. hypogaea. Cultivated peanut derived all of its genetic material from two wild ancestors, A. duranensis and A. ipaensis whose genomes merged several thousand years ago, in a rare genetic event. The wild species, therefore, have half as much genetic material as cultivated peanut. These two “simpler” genomes have first been sequenced toward achieving its ultimate goal: the complete genomic sequence for cultivated peanut. The cultivated peanut is an allotetraploid (2n=4x=40) that carries both the A and B genomes and A. ipaensis (2n=2x=20) has likely contributed the B genome, the larger set of chromosomes in the karyotype. These two ancestral diploids separated from each other about 3 million years ago. The genome merger, allopolyploidy event, ocurred relatively very recently, five to ten thousand years ago, followed by domestication in South America from where it appeared in most part of the world by 1600.'
WHERE taxonid='130454';

UPDATE organism SET description=
'Medicago truncatula, a close relative of alfalfa (M. sativa), is widely used as a model in legume biology. It is physically small in stature, with a small genome, and has a short generation-to-generation time.'
WHERE taxonid='3880';

UPDATE organism SET description='Arabidopsis thaliana is the most widely studied model plant species, with five completely sequenced and annotated chromosomes.'
WHERE taxonid='3702';
...
UPDATE organism SET description=
'Lotus japonicus, a forage crop (much like clover), is widely used as a model in legume biology. It is physically small in stature, with a small genome, and a short generation time, and it is relatively easily transformable (for gene functional studies).'
WHERE taxonid='34305';
