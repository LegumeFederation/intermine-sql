...
----------------------------------------------------------
UPDATE organism SET genus='Cicer',     species='arietinum',  name='Cicer arietinum',    commonname='chickpea',       shortname='C. arietinum'             WHERE taxonid='3827';
...
UPDATE organism SET genus='Vigna',     species='unguiculata subsp. sesquipedalis', name='Vigna unguiculata subsp. sesquipedalis',
							    commonname='asparagus bean', shortname='V. unguiculata subsp. sesquipedalis'                  WHERE taxonid='138955';
