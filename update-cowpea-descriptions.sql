...
UPDATE organism SET description='ZN016 is a rustic landrace asparagus bean (<i>Vigna. unguiculata ssp. sesquipedialis</i>) variety originating from southern China.' WHERE variety='ZN016';

UPDATE organism SET description='Zhijiang282 is a commercial asparagus bean(<i>Vigna. unguiculata ssp. sesquipedialis</i>) cultivar in China.' WHERE variety='Zhijiang282';
