...
UPDATE protein SET    primaryidentifier=replace(secondaryidentifier,'.p','') WHERE primaryidentifier LIKE 'vigun.%';
...
UPDATE mrna SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'Glyma.%';
UPDATE protein SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'Glyma.%';
UPDATE chromosome SET primaryidentifier='Gm'||substring(secondaryidentifier,10) WHERE primaryidentifier LIKE 'glyma.%';
UPDATE supercontig SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'glyma.%';
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
UPDATE chromosome  SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'aradu.%';
UPDATE supercontig SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'aradu.%';
...
UPDATE chromosome  SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'araip.%';
UPDATE supercontig SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'araip.%';
-- gene, exon, protein, mRNA OK
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
UPDATE chromosome  SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'lotja.%';
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
UPDATE chromosome  SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'vigra.%';
UPDATE supercontig SET primaryidentifier=secondaryidentifier WHERE primaryidentifier LIKE 'vigra.%';
UPDATE gene        SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'vigra.%';
UPDATE exon        SET primaryidentifier=secondaryidentifier WHERE secondaryidentifier LIKE 'Vradi%';
UPDATE protein     SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'vigra.%';
UPDATE mrna        SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'vigra.%';
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
UPDATE chromosome  SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'cajca.%';
UPDATE supercontig SET primaryidentifier=secondaryidentifier WHERE primaryidentifier LIKE 'cajca.%';
...
UPDATE chromosome  SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'lupan.%';
UPDATE supercontig SET primaryidentifier=secondaryidentifier WHERE primaryidentifier LIKE 'lupan.%';
UPDATE gene        SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'lupan.%';
-- exon can't be updated, nothing identifiable
UPDATE protein     SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'lupan.%';
UPDATE mRNA        SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'lupan.%';
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
UPDATE chromosome  SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'tripr.%';
UPDATE supercontig SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'tripr.%';
UPDATE gene        SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'tripr.%';
UPDATE exon        SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'tripr.%';
UPDATE protein     SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'tripr.%';
UPDATE mrna        SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'tripr.%';
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
UPDATE chromosome  SET primaryidentifier=secondaryidentifier WHERE primaryidentifier LIKE 'vigan.%';
UPDATE supercontig SET primaryidentifier=secondaryidentifier WHERE primaryidentifier LIKE 'vigan.%';
UPDATE gene        SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'vigan.%';
UPDATE exon        SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'vigan.%';
UPDATE protein     SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'vigan.%';
UPDATE mrna        SET primaryidentifier=substring(secondaryidentifier,7) WHERE primaryidentifier LIKE 'vigan.%';
