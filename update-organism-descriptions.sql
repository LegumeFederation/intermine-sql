...
UPDATE organism SET description='<i>Arabidopsis thaliana</i> is the most widely studied model plant species, with five completely sequenced and annotated chromosomes.'
WHERE taxonid=3702;
