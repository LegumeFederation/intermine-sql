...
SELECT primaryidentifier,secondaryidentifier,substring(description,1,10) AS description,genefamilyid FROM gene WHERE gene.secondaryidentifier LIKE 'lupan.%' ORDER BY primaryidentifier LIMIT 5;
SELECT primaryidentifier,secondaryidentifier,substring(description,1,10) AS description,genefamilyid FROM gene WHERE gene.secondaryidentifier LIKE 'vigra.%' ORDER BY primaryidentifier LIMIT 5;
SELECT primaryidentifier,secondaryidentifier,substring(description,1,10) AS description,genefamilyid FROM gene WHERE gene.secondaryidentifier LIKE 'araip.%' ORDER BY primaryidentifier LIMIT 5;
SELECT primaryidentifier,secondaryidentifier,substring(description,1,10) AS description,genefamilyid FROM gene WHERE gene.secondaryidentifier LIKE 'lotja.%' ORDER BY primaryidentifier LIMIT 5;
SELECT primaryidentifier,secondaryidentifier,substring(description,1,10) AS description,genefamilyid FROM gene WHERE gene.secondaryidentifier LIKE 'phavu.%' ORDER BY primaryidentifier LIMIT 5;
